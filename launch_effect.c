...
void launch_effect (int effect)
{
	...
	switch (effect)
	{
		...
		case 3:
			effect_z_updown(20,500);
			break;
				
		case 4:
			effect_wormsqueeze (2, AXIS_Z, -1, 50, 1000);
			break;
		...
		case 11:
			effect_wormsqueeze (1, AXIS_X, 1, 100, 1000);
			break;
			
			
		case 12:
			effect_stringfly2("Josh Rules!");
			break;
